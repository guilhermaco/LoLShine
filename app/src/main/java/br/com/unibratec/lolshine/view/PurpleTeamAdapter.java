...
public class PurpleTeamAdapter extends ArrayAdapter<Player> {

    public PurpleTeamAdapter(Context context, List<Player> players) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null){
            convertView = LayoutInflater.from(getContext())
                    .inflate(R.layout.list_item_purple_player, null);
        }
